...
virt-install --name="$distro" --vcpus="$cpu" --graphics spice --network network=default --memory="$mem" --cdrom="/home/akula/Documents/Media/Iso/$iso" --disk size="$gb" --os-variant="$os" --boot "$boot" &
